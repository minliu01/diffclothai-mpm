...
Simulation::FabricConfiguration  OptimizationTaskConfigurations::tie = {
        .clothDimX = 6,
        .clothDimY = 6,
        .k_stiff_stretching = 3000.0,
        .k_stiff_bending = 10.0, // TODO: change back
        .gridNumX = 40, // 25,
        .gridNumY = 80, //50,
        .density = 1.0,
        .keepOriginalScalePoint = true,
        ...
        .fabricIdx = FabricEnumArray::TSHIRT1000,
        .color = COLOR_RED,
        .name =  "remeshed/Hanger/tie_action_select.obj",
};

Simulation::FabricConfiguration  OptimizationTaskConfigurations::towel = {
        .clothDimX = 6,
        .clothDimY = 6,
...
Simulation::SceneConfiguration OptimizationTaskConfigurations::hangerScene{
        ...
        .orientation = Orientation::FRONT,
        .attachmentPoints = AttachmentConfigs::CUSTOM_ARRAY,
        .customAttachmentVertexIdx = {{0.0, {}}},  // {{1.0, {96, 55}}} {{0.0, {601, 390}}}
        .trajectory = TrajectoryConfigs::TRAJECTORY_CLOTH_HANGER,
        .primitiveConfig = PrimitiveConfiguration::CLOTH_HANGER,
        .windConfig = WindConfig::NO_WIND,
        .camPos = Vec3d(-22.14, 9.24, 7.59),
        .camFocusPointType =  CameraFocusPointType::CLOTH_CENTER,
        .sceneBbox =  AABB(Vec3d(-7, -7, -7), Vec3d(7, 7, 7)), //.sceneBbox =  AABB(Vec3d(-5, -1.5, -14), Vec3d(7, 10, 5)),
        .timeStep = 1.0 / 100.0,
        .stepNum = 200,
        .forwardConvergenceThresh = 1e-8,
        .backwardConvergenceThresh = 5e-4,
...
Simulation::SceneConfiguration OptimizationTaskConfigurations::towelScene{
        .fabric = towel,
        .orientation = Orientation::FRONT,
        .attachmentPoints = AttachmentConfigs::CUSTOM_ARRAY,
...
Simulation::TaskConfiguration OptimizationTaskConfigurations::demoHanger = {
        .scene = towelScene,
        .hasGroundtruth = false,
        .generateGroundtruthSimulation = false,
...
std::vector<Simulation::SceneConfiguration>  OptimizationTaskConfigurations::sceneConfigArrays = {
        windScene, continousNormalScene, rotatingSphereScene, hatScene, sockScene, tshirtScene, dressScene, hangerScene, towelScene
};