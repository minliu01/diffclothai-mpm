...
//    static AttachmentConfigs restPosConfiguration;
    ...
    Simulation(
            ...
            cube3(Vec3d(0, 0, 0), 0.05, 0.05, 0.15),
            tmp_plane(Vec3d(0,-1.5,0), Vec3d(7,-1.5,7), Vec3d(-7,-1.5,7), COLOR_GRAY50),
    ...
    collisionClip(const VecXd &x_n, const VecXd &v, const VecXd &x_prim, const VecXd &v_prim);
...
//    VecXd calculateDryFrictionAndVelocityVector(const VecXd &f, VecXd &v) const;
    Vec3d calcualteDryFrictionForce(const Vec3d &n, const Vec3d &f_i, double mu, int &type) const;
