...
public:
    ...
    static void
    fillTriangleToVertexArr(Triangle &m, float *vertexArr, int offset, int numFields, Vec3d color, Vec3d center, Mat3x3d rotation,
                            bool useVertexNormal = true);
    ...
    static void renderPrimitive(Primitive& p, Shader* shader, Vec3d center, Mat3x3d rotation);
